...
class AILoungeVisualizer {
    ...
    stopCurrentMedia() {
        ...
        // Stop video/audio element
        this.videoElement.pause();
        this.videoElement.currentTime = 0;
        
        // Remove old source to prevent issues
    ...
    async togglePlay() {
        if (this.mediaType === 'image') {
            // For images, toggle the visualization
    ...
    async playNext() {
        ...
        const nextIndex = this.currentIndex < this.playlist.length - 1 
            ? this.currentIndex + 1 
            : 0;
    ...
    onCanPlay() {
        ...
        console.log('Media ready to play');
    }
